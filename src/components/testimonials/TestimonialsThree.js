...
export default function TestimonialsThree() {
  const testimonials = [
    {
      text: "Binary Labs Solutions transformed our agricultural business with their custom software solution. Their team developed an intuitive crop management system that has increased our yield by 30% and significantly reduced water waste.",
