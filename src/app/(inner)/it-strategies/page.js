                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="inner-content">
                                    <div className="top">
                                        <h1 className="title">IT Strategies</h1>
                                        <p className="disc">
                                            IT strategies align technology with business goals, optimize resources, enhance efficiency, ensure security, and drive innovation.
                                        </p>
                                    </div>
